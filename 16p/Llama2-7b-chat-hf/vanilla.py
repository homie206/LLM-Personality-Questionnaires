...
def get_model_examing_result(model_id):
    ...
    for mbti_item in prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'/home/hmsun/LLM-Personality-Questionnaires/16p/Llama2-7b-chat-hf/vanilla-result/{mbti_label_content}-vanilla-induce-mbti-Llama-2-7b-chat-hf-output.txt'
        result_file_name = f'/home/hmsun/LLM-Personality-Questionnaires/16p/Llama2-7b-chat-hf/vanilla-result/{mbti_label_content}-vanilla-induce-mbti-Llama-2-7b-chat-hf-result.csv'
...
def get_single_dim_model_examing_result(model_id):
    ...
    for mbti_item in single_prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'/home/hmsun/LLM-Personality-Questionnaires/16p/Llama2-7b-chat-hf/vanilla-result/{mbti_label_content}-vanilla-induce-mbti-Llama2-7b-chat-hf-output.txt'
        result_file_name = f'/home/hmsun/LLM-Personality-Questionnaires/16p/Llama2-7b-chat-hf/vanilla-result/{mbti_label_content}-vanilla-induce-mbti-Llama2-7b-chat-hf-result.csv'
