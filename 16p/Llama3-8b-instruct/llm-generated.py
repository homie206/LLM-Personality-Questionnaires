...
prompt_template = {
    "mbti_prompt": [
        {
            "prompt": "Please use a paragraph to describe a human who is an ISTJ person. ",
            "label": "ISTJ"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an ISTP person.",
            "label": "ISTP"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an ISFJ person. ",
            "label": "ISFJ"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an ISFP person. ",
            "label": "ISFP"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an INTJ person. ",
            "label": "INTJ"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an INTP person. ",
            "label": "INTP"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an INFJ person. ",
            "label": "INFJ"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an INFP person. ",
            "label": "INFP"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an ESTJ person. ",
            "label": "ESTJ"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an ESTP person. ",
            "label": "ESTP"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an ESFJ person. ",
            "label": "ESFJ"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an ESFP person. ",
            "label": "ESFP"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an ENTJ person. ",
            "label": "ENTJ"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an ENTP person. ",
            "label": "ENTP"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is ENFJ person. ",
            "label": "ENFJ"
        },
        {
            "prompt": "Please use a paragraph to describe a human who is an ENFP person. ",
            "label": "ENFP"
        }
    ]
}
...
def get_model_examing_result(model_id):
    ...
    for mbti_item in prompt_template["mbti_prompt"][8:]:

        mbti_prompt = mbti_item["prompt"]
        mbti_label_content = mbti_item["label"]

        output_file_name = f'/home/hmsun/LLM-Personality-Questionnaires/16p/Llama3-8b-instruct/llm-generated-result/{mbti_label_content}-generated-prompt-induce-mbti-llama3-8b-instruct-output.txt'
        result_file_name = f'/home/hmsun/LLM-Personality-Questionnaires/16p/Llama3-8b-instruct/llm-generated-result/{mbti_label_content}-generated-prompt-induce-mbti-llama3-8b-instruct-result.csv'
