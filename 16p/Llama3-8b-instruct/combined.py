...
def get_model_examing_result(model_id):
    ...
    for mbti_item in prompt_template["mbti_prompt"]:
        ...
        output_file_name = f'/home/hmsun/LLM-Personality-Questionnaires/16p/Llama3-8b-instruct/combine-result/{mbti_label_content}-combine-induce-mbti-llama3-8b-instruct-output.txt'
        result_file_name = f'/home/hmsun/LLM-Personality-Questionnaires/16p/Llama3-8b-instruct/combine-result/{mbti_label_content}-combine-induce-mbti-llama3-8b-instruct-result.csv'
